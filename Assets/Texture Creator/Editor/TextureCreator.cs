...
public class TextureCreator : MonoBehaviour
{
    ...
    [MenuItem("Unity Support/Create 1000 Groups, each 10 textures", false, 4)]
    public static void CreateSeveralGroups()
    {
        Debug.Log("Creating 1000 groups with 10 textures each");
    ...
    public static void CreateAddressableAssetGroup(string defaultFolder, string randomFolder)
    {
        ...
        AddressableAssetGroupTemplate template = groupTemplates.FirstOrDefault(t => t.name == "SupportEngineQA") as AddressableAssetGroupTemplate;// 
